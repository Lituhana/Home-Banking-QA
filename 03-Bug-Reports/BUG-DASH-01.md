...
The Home Banking dashboard and "Transferencias" section do not adjust correctly when the browser window is resized, key UI elements are clipped or displaced, forcing the user to scroll down to interact with primary actions like the "Transferir" button.

## 🐾 Steps to Reproduce:

1. Log in and go to the dashboard section.
2. Resize the browser window to a smaller width.
...
- **Evidence: [BUG-DASH-01]**(https://github.com/Lituhana/Home-Banking-QA-Project/blob/main/04-Evidence/Screenshots%20%26%20Videos/BUGS/BUG-DASH-01.png)